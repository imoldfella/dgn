...
export const Dialog = component$<DivProps & { open: Signal<boolean> }>((props) => {
  return <div></div>
})
export const Overlay = component$<DivProps & motion.MotionProps>((props) => {
  return <div></div>
})
...
export const Modal = component$<DivProps&ModalProps>((props) => {
  return <Dialog class="fixed inset-0 z-10" open={props.open} >
