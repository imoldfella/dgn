...
export const PostItem = component$(({ post }: any) => {
...
export const Debug = component$(({ query }: { query: QueryResult<any> }) => {
    return null
    return <div class='fixed z-40' >
...
export const PostStream = component$<{ 
    query: QueryResult<UserPost> 
    oldestTop?: boolean
}>(({ query }) => {
    return <>
        {query.found && <>
